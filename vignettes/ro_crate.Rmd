...
use_virtualenv("../renv/python/virtualenvs/renv-python-3.9.4/", required=T)
use_python("../renv/python/virtualenvs/renv-python-3.9.4/bin/python")
py_config()
py_install("rocrate", envname = "../renv/python/virtualenvs/renv-python-3.9.4/")
```
