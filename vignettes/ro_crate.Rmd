...
use_virtualenv("../renv/python/virtualenvs/renv-python-3.9.2/", required=T)
use_python("../renv/python/virtualenvs/renv-python-3.9.2/bin/python", required=T)
py_config()
py_install("rocrate", envname = "../renv/python/virtualenvs/renv-python-3.9.2/")
```
